...
public class d_login extends AppCompatActivity {
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user.equals("")||passw.equals(""))
                    Toast.makeText(d_login.this, "Please enter all the fields", Toast.LENGTH_SHORT).show();
                else{
                    Boolean checkuserpass = check(user,passw);
                    if(checkuserpass==true){
                        Toast.makeText(d_login.this, "Sign in successfull", Toast.LENGTH_SHORT).show();
                        Intent intent  = new Intent(getApplicationContext(), driver_dash.class);
                        intent.putExtra("uname",user);
                        startActivity(intent);
                    }else{
                        Toast.makeText(d_login.this, "Invalid Credentials", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public boolean check(String user, String passw)
    {
        ...
        wdatabase.child("users").child("drivers").child(user).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            @Override
