    ...
    protected String doInBackground(String... params) {
        try {
            ...
            if(statuscode==HttpURLConnection.HTTP_OK)
            {
                ...
                String duration=object_elements.getJSONObject("duration").getString("text");
                String distance=object_elements.getJSONObject("distance").getString("value");
                JSONObject object_distance=object_elements.getJSONObject("distance");
                Log.d("JSON","object_distance:"+distance);
                Log.d("JSON","object_duration:"+duration);
